  ...
  return (
    <main className={styles.page}>
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          <h2 className={styles.heading}>6. Registrierung und Nutzerkonto</h2>
          ...
          <p>
            Diese Daten werden ausschließlich für den Betrieb Ihres Kontos und die Kommunikation
            mit Ihnen genutzt. Sie können Ihr Konto jederzeit über die Einstellungen löschen oder
            uns unter{' '}
            <a href={`mailto:${legal.email}`}>{legal.email}</a> kontaktieren.
          </p>
        </section>
